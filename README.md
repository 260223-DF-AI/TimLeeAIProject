...
Initial plan for the project: use the [statefarm distracted driver image database](https://www.kaggle.com/competitions/state-farm-distracted-driver-detection/data) and train/classify to predict on its 10 classes. Answering task g:
